...
from ansible.modules.storage.netapp.na_ontap_export_policy \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_export_policy.NetAppONTAPExportPolicy.create_export_policy')
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_export_policy.NetAppONTAPExportPolicy.get_export_policy')
    @patch('ansible.modules.storage.netapp.na_ontap_export_policy.NetAppONTAPExportPolicy.rename_export_policy')
