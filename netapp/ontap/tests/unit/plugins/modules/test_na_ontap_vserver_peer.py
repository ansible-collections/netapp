...
from ansible.modules.storage.netapp.na_ontap_vserver_peer \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_vserver_peer.NetAppONTAPVserverPeer.vserver_peer_get')
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_vserver_peer.NetAppONTAPVserverPeer.get_peer_cluster_name')
