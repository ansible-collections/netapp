...
from ansible.modules.storage.netapp.na_ontap_qtree \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_qtree.NetAppOntapQTree.create_qtree')
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_qtree.NetAppOntapQTree.delete_qtree')
    ...
    @patch('ansible.modules.storage.netapp.na_ontap_qtree.NetAppOntapQTree.modify_qtree')
