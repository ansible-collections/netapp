...
""" unit tests for Ansible module: na_um_list_nodes """
...
from ansible_collections.netapp.um.plugins.modules.na_um_list_nodes\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um.plugins.modules.na_um_list_nodes.NetAppUMNode.get_nodes')
