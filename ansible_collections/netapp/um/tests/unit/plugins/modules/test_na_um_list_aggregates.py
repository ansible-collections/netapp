...
""" unit tests for Ansible module: na_um_list_aggregates """
...
from ansible_collections.netapp.um.tests.unit.compat import unittest
from ansible_collections.netapp.um.tests.unit.compat.mock import patch, Mock
from ansible.module_utils import basic
from ansible.module_utils._text import to_bytes

from ansible_collections.netapp.um.plugins.modules.na_um_list_aggregates\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um.plugins.modules.na_um_list_aggregates.NetAppUMAggregate.get_aggregates')
