...
from ansible_collections.netapp.um.plugins.modules.na_um_list_clusters\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um.plugins.modules.na_um_list_clusters.NetAppUMCluster.get_clusters')
