...
""" unit tests for Ansible module: na_um_list_svms """
...
from ansible_collections.netapp.um_info.plugins.modules.na_um_list_svms\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um_info.plugins.modules.na_um_list_svms.NetAppUMSVM.get_svms')
