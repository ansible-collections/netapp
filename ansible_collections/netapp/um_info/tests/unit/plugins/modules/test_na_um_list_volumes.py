...
""" unit tests for Ansible module: na_um_list_volumes """
...
from ansible_collections.netapp.um_info.plugins.modules.na_um_list_volumes\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um_info.plugins.modules.na_um_list_volumes.NetAppUMVolume.get_volumes')
