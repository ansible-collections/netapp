...
from ansible_collections.netapp.um_info.plugins.modules.na_um_list_nodes\
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.um_info.plugins.modules.na_um_list_nodes.NetAppUMNode.get_nodes')
